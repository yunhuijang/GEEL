...
class EgoDataset(Dataset):
    ...
    is_mol = False
    def __init__(self, graphs, string_type, is_token):
    ...
    def __getitem__(self, idx: int):
        return torch.LongTensor(tokenize(self.adjs[idx], self.adj_list[idx], self.data_name, self.string_type, self.is_token))
